...
SCHEMA_FILENAMES = {
    **{
        ...
        for name in ("native-source", "native-registration", "native-projection")
    },
    **{
        name: name + ".schema.json"
    ...
    "residual-market-report": "residual-market-report.schema.json",
    "residual-bounty": "residual-bounty.schema.json",
    "residual-bounty-report": "residual-bounty-report.schema.json",
    "residual-diff": "residual-diff.schema.json",
    "residual-diff-report": "residual-diff-report.schema.json",
